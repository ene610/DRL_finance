...
class CryptoTradingEnv(gym.Env):
    ...
    def __init__(self, df, frame_bound, window_size: int = 22, indicators=['diff_pct_1', 'diff_pct_5', 'diff_pct_15', 'diff_pct_22'], position_in_observation: bool = True):
        assert df.ndim == 2
    ...
    def sharpe_calculator(self, current_balance, rf=0):
        ...
        # rf = 0
        roi = (current_balance - self.returns_balance[self._open_position_tick]) / self.returns_balance[
    ...
    def sharpe_calculator_total(self, rf=0):
        ...
        print(self.returns_balance.values())
        # rf = 0
